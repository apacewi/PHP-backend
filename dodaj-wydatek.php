...
<title>Oszczędzanko-dodaj-wydatek</title>
		...
		<main class="container">
			<div class="row justify-content-center">
				<div class="col-12 col-sm-10 col-md-8 pt-2 pb-3 rounded">
					<span class="text-center text-white d-block pt-3 h3">DODAJ WYDATEK:</span>				
					<div class="col-11 m-auto pt-4">
						<div class="pb-2 bg-light rounded mb-3 px-3 info-place text-break bg-light">
							<fieldset class="border-mine border-danger pb-3 px-2">
								<legend  class="w-auto"><h5>Kwota wydatku</h5></legend>
								<div class="form-group text-center">
									<label for="price-input" class="col-8 col-form-label">Wysokość wydatku:</label>
									<div class ="col-8 m-auto">
										<input class="form-control" id="price-input" type="text" placeholder="Kwota">
									</div>
								</div>
							</fieldset>
						</div>					
						<div class="pb-2 bg-light rounded mb-3 px-3 info-place text-break bg-light">
							<fieldset class="border-mine border-danger pb-3 px-2">
								...
								<div class="form-group text-center">
									<label for="date-input" class="col-8 col-form-label">Data zrealizowania wydatku:</label>
									<div class="col-8 m-auto">
						...
						<div class="pb-2 bg-light rounded mb-3 px-3 info-place text-break bg-light">
							<fieldset class="border-mine border-danger pb-3 px-2">
								<legend  class="w-auto"><h5>Tytuł wydatku </h5></legend>
									<div class ="col-8 m-auto">
										<select class="form-control list text-center">
						...
						<div class="pb-2 bg-light rounded mb-3 px-3 info-place text-break bg-light">
							<fieldset class="border-mine border-danger pb-3 px-2">
								<legend  class="w-auto"><h5>Sposób płatności </h5></legend>
								<div class="text-center px-3">
									<div class = "py-1 mb-1">
										<label>
											<input type="radio" name="Sposób płatności"> Gotówka
										</label>
									</div>			
									<div class = "py-1 mb-1">
										<label>
											<input type="radio" name="Sposób płatności"> Karta Kredytowa
										</label>
									</div>
									<div class = "py-1 mb-1">
										<label>
											<input type="radio" name="Sposób płatności"> Karta Debetowa 
										</label>
									</div>
									<div class = "py-1 mb-1">
										<label>
						...
						<div class="buttons-sizing-forms rounded buttons-underline border-danger text-center m-auto" onclick="addcomment()">
						...
						<div class="input-group mt-3 mb-3 d-inline-block text-center buttons-pos">
							...
							<div class="input-group mt-3 mb-3 d-inline-block text-center buttons-pos">
								 <button type="submit" class="btn btn-danger btn-lg"> Anuluj Formularz </button>
						</div>
					</div>	
				</div>		
			</div>	
